...
public class Comment {
	...
	@OnDelete(action=OnDeleteAction.CASCADE) //post silindiğinde yorumlarda sılınsın
	@JsonIgnore
	Post post;
	
	@ManyToOne(fetch=FetchType.LAZY) // LAZY Comment i cektiğimizde user gelmesin anlamına geliyor. EAGER tam tersi
